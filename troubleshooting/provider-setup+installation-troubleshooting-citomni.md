...
| Config overrides don't stick                                           | Using list arrays or wrong files                                                            | **Config is deep last-wins.** Ensure you override with associative keys in `/config/citomni_{http or cli}_cfg.php`(and optional`{ENV}` file).                                                                              |
